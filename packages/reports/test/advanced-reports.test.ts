...
test("formats PR comments with actionable repair guidance", () => {
  ...
  const npmNoticeIndex = comment.indexOf("Local `npx @evidoc/evidoc` commands use the published npm package");
  ...
  assert.match(comment, /npx @evidoc\/evidoc fix --safe --json/);
  assert.match(comment, /npx @evidoc\/evidoc fix --safe --write --json/);
  assert.match(comment, /npx @evidoc\/evidoc diagnose/);
  assert.match(comment, /npx @evidoc\/evidoc fix --safe --json --root <target-repository-root>/);
  assert.match(comment, /npx @evidoc\/evidoc fix --safe --write --json --root <target-repository-root>/);
  assert.match(comment, /npx @evidoc\/evidoc diagnose --root <target-repository-root>/);
  assert.match(comment, /npx @evidoc\/evidoc check --fail-on=review_needed --root <target-repository-root>/);
...
test("formats PR comments with a copy-paste agent repair prompt", () => {
  ...
  assert.match(comment, /```text[\s\S]*npx @evidoc\/evidoc fix --safe --json --root <target-repository-root>/);
  assert.match(comment, /```text[\s\S]*npx @evidoc\/evidoc fix --safe --write --json --root <target-repository-root>/);
  assert.match(comment, /```text[\s\S]*npx @evidoc\/evidoc diagnose --root <target-repository-root>/);
  assert.match(comment, /```text[\s\S]*npx @evidoc\/evidoc check --fail-on=review_needed --root <target-repository-root>/);
...
test("formats PR comments with published npm and source-checkout commands", () => {
  ...
  assert.match(comment, /Local `npx @evidoc\/evidoc` commands use the published npm package/);
